...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets_admin/vendors/flag-icon-css/css/flag-icon.min.css');?>">
    <link rel="stylesheet" href="<?php echo base_url('assets_admin/vendors/css/vendor.bundle.base.css'); ?>">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="<?php echo base_url('assets_admin/vendors/font-awesome/css/font-awesome.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets_admin/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css'); ?>">
