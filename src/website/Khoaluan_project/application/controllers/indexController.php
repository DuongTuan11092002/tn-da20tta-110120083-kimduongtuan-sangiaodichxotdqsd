...
class indexController extends CI_Controller
{
	...
	public function category_product_business($id)
	{
		...
		$config = array();
		$config["base_url"] = base_url() . '/danh-muc-san-pham-doanh-nghiep' . '/' . $id;
		$config['total_rows'] = ceil($this->indexModel->countAllProductByBusiness($id)); //đếm tất cả sản phẩm //8 //hàm ceil làm tròn phân trang 
